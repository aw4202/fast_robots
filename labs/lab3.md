...
The short ranging distance was found to be up to about 2.0 meters. The measurements were highly repeatable and accurate, with the same prediction function used for all of them and the average of the between the expected and predicted being 100mm or less across all 5 trials. The ranging time to consistently be around 52 mS regardless of distance then to drop to around 30 mS once the range was exceeded and sensor stopped working.
